    	...
    	<section id="branding">
            <a href="index.php"><img src="Images/bannar.png" class="img-responsive" alt="BrandImage"></a>
        </section>
    	<div class="navbar navbar-default" role="navigator">
        	...
        	<ul class="nav navbar-nav">
            	<li class="active"><a href="index.php"><span class="fa fa-home"> Home</a></li>
                ...
                <li><a href="adminlogin.php" data-toggle="modal" data-target="#myModal"><span class="fa fa-wrench"></span> Admin Login</a></li>
            </ul>
